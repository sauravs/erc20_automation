...
import {FeatureFlashMint} from "./CodeSnippet.sol";

/// @title FlashMintFactory - Factory contract for deploying ERC20 tokens with basic features 1)mint 2)burn 3)pause 4) basic access control 5) flash minting
